...
const Signin = () => {
    ...
    return (
        <form className="w-full max-w-2xl mx-auto" onSubmit={handleLogin}>
            ...
            <button type="submit" className="block w-full bg-indigo-600 mt-5 py-2 rounded-2xl hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">Connection</button>
