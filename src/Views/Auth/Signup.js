...
const Signup = () => {
    ...
    return (
        <form className="w-full max-w-2xl mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl ">
                <input className="pl-2 w-full outline-none border-none" type="password" name="password" id="password" placeholder="Confirmer mot de passe" onChange={e=>setValidatePassword(e.target.value)}/>
            </div>
            <button type="submit" className="block w-full bg-indigo-600 mt-5 py-2 rounded-2xl hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">S'inscrire</button>
